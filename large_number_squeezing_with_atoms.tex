...
Figure~\ref{figBogSqueezingValidation} demonstrates the agreement between truncated Wigner simulations and the Bogoliubov theory for the fractional occupation of the non-zero momentum modes for parameters where the occupation of these modes approach 20\%\footnote{FIXME} of the total occupation of the system.  The disagreement for larger fractional occupations occurs because the Bogoliubov theory used in deriving \eqref{eqCondensateDepletion} is not number-conserving as it neglects the effect of the non-zero momentum modes on the condensate.  
