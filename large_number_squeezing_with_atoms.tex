...
\begin{figure}
    \centering
    \includegraphics[width=8cm]{figures/dimensional_effects_on_squeezing.eps}
    \caption{Effects of dimension on squeezing. Thick red line, analytic two-mode solution; solid blue line, 1D; dashed line, 2D; dash-dotted line, 3D. Parameters: $n_a = n_b =2 \times 10^5$, $\chi_{aa}=\chi_{bb}=0.03 \hbar, \tau_{\mathrm{hold}}=3\times 10^{-4}$s, $\phi=6.2$. }
    \label{figDimensionallSqueezingEffects}
\end{figure}
